...
namespace WinFormsApp1
{
    ...
    public class LineNumberStrip : Control
    {
        ...
        /// <summary>
        /// We need to pass in the MainForm so we can check the form _state, Do not
        ...
        {
            // Make the line numbers virtually invisble when no _lines present
        ...
        {
            // If word wrap is enabled do not check for line changes as new _lines
        ...
        {
            // Decrease the paint calls by one half when there is more than 3000 _lines
        ...
        /// <summary>
        /// Gets or sets the scrolling speed in the number of _lines
