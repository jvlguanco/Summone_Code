...
public abstract class SyntaxAnalyzer : Analyzer {
    public override void Enter(Node node) {
        ...
        case (int) SyntaxConstants.PROD_G_ADD_PING_2D:
            ...
            break;
        case (int) SyntaxConstants.PROD_G_PING_ADD:
            EnterProdGPingAdd((Production) node);
            break;
        ...
        case (int) SyntaxConstants.PROD_TOWER_VAR:
            ...
            break;
        case (int) SyntaxConstants.PROD_T_MEMBER_TYPE:
            EnterProdTMemberType((Production) node);
            break;
        case (int) SyntaxConstants.PROD_T_OP_ARR:
            EnterProdTOpArr((Production) node);
            break;
        case (int) SyntaxConstants.PROD_T_ADD_ARR:
            EnterProdTAddArr((Production) node);
            break;
        ...
        case (int) SyntaxConstants.PROD_LOOP_STM:
            ...
            break;
        case (int) SyntaxConstants.PROD_LOWER_BOUND:
            EnterProdLowerBound((Production) node);
            break;
        case (int) SyntaxConstants.PROD_UPPER_BOUND:
            EnterProdUpperBound((Production) node);
            break;
        ...
        case (int) SyntaxConstants.PROD_USER_BODY:
            ...
            break;
        case (int) SyntaxConstants.PROD_INTER_RECALL:
            EnterProdInterRecall((Production) node);
            break;
        case (int) SyntaxConstants.PROD_BLOAT_RECALL:
            EnterProdBloatRecall((Production) node);
            break;
        case (int) SyntaxConstants.PROD_PING_RECALL:
            EnterProdPingRecall((Production) node);
            break;
        case (int) SyntaxConstants.PROD_PING_RECALL_VALUE:
            EnterProdPingRecallValue((Production) node);
            break;
        case (int) SyntaxConstants.PROD_POOL_RECALL:
            EnterProdPoolRecall((Production) node);
            break;
        }
    }
    ...
    public override Node Exit(Node node) {
        ...
        case (int) SyntaxConstants.PROD_G_PING_ADD:
            return ExitProdGPingAdd((Production) node);
        case (int) SyntaxConstants.PROD_GV_POOL:
        ...
        case (int) SyntaxConstants.PROD_T_MEMBER_TYPE:
            return ExitProdTMemberType((Production) node);
        case (int) SyntaxConstants.PROD_T_OP_ARR:
            return ExitProdTOpArr((Production) node);
        case (int) SyntaxConstants.PROD_T_ADD_ARR:
        ...
        case (int) SyntaxConstants.PROD_LOWER_BOUND:
            return ExitProdLowerBound((Production) node);
        case (int) SyntaxConstants.PROD_UPPER_BOUND:
            return ExitProdUpperBound((Production) node);
        case (int) SyntaxConstants.PROD_CONTENT:
        ...
        case (int) SyntaxConstants.PROD_INTER_RECALL:
            return ExitProdInterRecall((Production) node);
        case (int) SyntaxConstants.PROD_BLOAT_RECALL:
            return ExitProdBloatRecall((Production) node);
        case (int) SyntaxConstants.PROD_PING_RECALL:
            return ExitProdPingRecall((Production) node);
        case (int) SyntaxConstants.PROD_PING_RECALL_VALUE:
            return ExitProdPingRecallValue((Production) node);
        case (int) SyntaxConstants.PROD_POOL_RECALL:
            return ExitProdPoolRecall((Production) node);
        }
        return node;
    }
    ...
    public override void Child(Production node, Node child) {
        ...
        case (int) SyntaxConstants.PROD_TOWER_VAR:
            ...
            break;
        case (int) SyntaxConstants.PROD_T_MEMBER_TYPE:
            ChildProdTMemberType(node, child);
            break;
        case (int) SyntaxConstants.PROD_T_OP_ARR:
            ChildProdTOpArr(node, child);
            break;
        case (int) SyntaxConstants.PROD_T_ADD_ARR:
            ChildProdTAddArr(node, child);
            break;
        case (int) SyntaxConstants.PROD_ADD_T_MEM:
        ...
        case (int) SyntaxConstants.PROD_LOOP_STM:
            ...
            break;
        case (int) SyntaxConstants.PROD_LOWER_BOUND:
            ChildProdLowerBound(node, child);
            break;
        case (int) SyntaxConstants.PROD_UPPER_BOUND:
            ChildProdUpperBound(node, child);
            break;
        case (int) SyntaxConstants.PROD_CONTENT:
        ...
        case (int) SyntaxConstants.PROD_USER_BODY:
            ...
            break;
        case (int) SyntaxConstants.PROD_INTER_RECALL:
            ChildProdInterRecall(node, child);
            break;
        case (int) SyntaxConstants.PROD_BLOAT_RECALL:
            ChildProdBloatRecall(node, child);
            break;
        case (int) SyntaxConstants.PROD_PING_RECALL:
            ChildProdPingRecall(node, child);
            break;
        case (int) SyntaxConstants.PROD_PING_RECALL_VALUE:
            ChildProdPingRecallValue(node, child);
            break;
        case (int) SyntaxConstants.PROD_POOL_RECALL:
            ChildProdPoolRecall(node, child);
            break;
        }
    }
    ...
    public virtual void EnterProdGPingAdd(Production node) {
    }

    public virtual Node ExitProdGPingAdd(Production node) {
        return node;
    }

    public virtual void ChildProdGPingAdd(Production node, Node child) {
        node.AddChild(child);
    }
    ...
    public virtual Node ExitProdGPoolAdd(Production node) {
        return node;
    }

    public virtual void ChildProdGPoolAdd(Production node, Node child) {
        node.AddChild(child);
    }
    ...
    public virtual void EnterProdTMemberType(Production node) {
    }

    public virtual Node ExitProdTMemberType(Production node) {
        return node;
    }

    public virtual void ChildProdTMemberType(Production node, Node child) {
        node.AddChild(child);
    }

    public virtual void EnterProdTOpArr(Production node) {
    }

    public virtual Node ExitProdTOpArr(Production node) {
        return node;
    }

    public virtual void ChildProdTOpArr(Production node, Node child) {
        node.AddChild(child);
    }

    public virtual void EnterProdTAddArr(Production node) {
    }

    public virtual Node ExitProdTAddArr(Production node) {
        return node;
    }

    public virtual void ChildProdTAddArr(Production node, Node child) {
        node.AddChild(child);
    }

    public virtual void EnterProdAddTMem(Production node) {
    }

    public virtual Node ExitProdAddTMem(Production node) {
        return node;
    }

    public virtual void ChildProdAddTMem(Production node, Node child) {
        node.AddChild(child);
    }
    ...
    public virtual void EnterProdLowerBound(Production node) {
    }

    public virtual Node ExitProdLowerBound(Production node) {
        return node;
    }

    public virtual void ChildProdLowerBound(Production node, Node child) {
        node.AddChild(child);
    }

    public virtual void EnterProdUpperBound(Production node) {
    }

    public virtual Node ExitProdUpperBound(Production node) {
        return node;
    }

    public virtual void ChildProdUpperBound(Production node, Node child) {
        node.AddChild(child);
    }
    ...
    public virtual void EnterProdInterRecall(Production node) {
    }

    public virtual Node ExitProdInterRecall(Production node) {
        return node;
    }

    public virtual void ChildProdInterRecall(Production node, Node child) {
        node.AddChild(child);
    }

    public virtual void EnterProdBloatRecall(Production node) {
    }

    public virtual Node ExitProdBloatRecall(Production node) {
        return node;
    }

    public virtual void ChildProdBloatRecall(Production node, Node child) {
        node.AddChild(child);
    }

    public virtual void EnterProdPingRecall(Production node) {
    }

    public virtual Node ExitProdPingRecall(Production node) {
        return node;
    }

    public virtual void ChildProdPingRecall(Production node, Node child) {
        node.AddChild(child);
    }

    public virtual void EnterProdPingRecallValue(Production node) {
    }

    public virtual Node ExitProdPingRecallValue(Production node) {
        return node;
    }

    public virtual void ChildProdPingRecallValue(Production node, Node child) {
        node.AddChild(child);
    }

    public virtual void EnterProdPoolRecall(Production node) {
    }

    public virtual Node ExitProdPoolRecall(Production node) {
        return node;
    }

    public virtual void ChildProdPoolRecall(Production node, Node child) {
        node.AddChild(child);
    }
}